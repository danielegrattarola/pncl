...
- [Options](#options)
  * [`Pencil()`](#-pencil---)
  * [`Pencil.line() | bar() | radar() | pie() | doughnut() | polar_area() | scatter()`](#-pencilline-----bar-----radar-----pie-----doughnut-----polar-area-----scatter---)
  * [`Pencil.refresh()`](#-pencilrefresh---)
  * [`Pencil.push()`](#-pencilpush---)
  * [`Pencil.set_grid()`](#-pencilset-grid---)
  * [`Pencil.browser()`](#-pencilbrowser---)
  * [`Pencil.stop()`](#-pencilstop---)
